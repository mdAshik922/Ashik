...
const Projects = () => {
 ...
 <h2 style={{color: "white", marginLeft: "30%", marginBottom: "4%", fontSize: "4rem", fontWeight: "bolder"}}>projects</h2>
<div style={{display: "flex", flexDirection: "row"}} >
           ...
           <img width="55%" src="https://i.ibb.co/zN9jjNx/Screenshot-6.png" alt="Brand-store"/>
            <div class="d-flex justify-content-between align-items-center"><div className="btn-group">
             ...
             target="_bank" className="btn btn-sm btn-outline-success">Live Site</Link>
             <Link to="https://github.com/mdAshik922/Brand-Shope" target="_blank" 
            className="btn btn-sm btn-outline-success">GitHub</Link></div></div>
           </div>
           ...
           <img width="55%" src="https://i.ibb.co/V9gMbdH/Screenshot-4.png" alt="summer-camp"/>
            ...
            className="btn btn-sm btn-outline-success">GitHub-Client</Link>
            <Link to="https://github.com/mdAshik922/summer_camp_server" target="_blank" 
            className="btn btn-sm btn-outline-success">GitHub-Server</Link></div></div>
           </div>
        ...
        <div style={{display: "flex", flexDirection: "row", marginTop: "15%"}}>
           ...
           <img width="55%" src="https://i.ibb.co/Yf2NtW2/Screenshot-10.png" alt="study"/>
            ...
            className="btn btn-sm btn-outline-success">GitHub</Link>
           </div></div>
           ...
           {/* <div style={{display: "flex", flexDirection: "row"}} >
            ...
            <div class="d-flex justify-content-between align-items-center"><div className="btn-group"><Link to="https://book-haven-client.web.app/"
             target="_bank" className="btn btn-sm btn-outline-success">Live Site</Link>
