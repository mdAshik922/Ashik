  ...
  <div className="progress-bar progress-bar-striped progress-bar-animated"
   role="progressbar" aria-valuenow="75" aria-valuemin="10" aria-valuemax="100"
    style={{width: "45%", backgroundColor: "#e056fd"}}></div>
        ...
        <aside>
        <img width="45%" style={{marginTop: "-45%", marginLeft: "10%", backgroundColor: "aquamarine", borderRadius: "", transform: "rotate(20deg)"}} src="https://i.ibb.co/6P322QP/illustrator-1.png" alt=""/>
        </aside>
        </article>
